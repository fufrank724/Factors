...
if __name__=='__main__':
    ...
    df = pd.read_csv('/home/frank/document/Python/Factors/data/data_1h_all.csv')
    ...
    ## Calc Data
    formula_list = []
    input_data_list = col_list.copy()
    with open('/home/frank/document/Python/Factors/data/data_list/one_step_data_list_20230208.csv','r') as f:
        input_data_list += f.read().split('\n')
    with open('/home/frank/document/Python/Factors/data/data_list/two_step_data_list_20230208.csv','r') as f:
        input_data_list += f.read().split('\n')
    ...
    fname = f'/home/frank/document/Python/Factors/output/backtest_result/D/inputdata_metrics.csv'
    prev_result = []
    ...
    for i in range(num_process):
        process_list.append(mp.Process(target = task, args = (i,input_data_list[i*ix:(i+1)*ix],)))
        process_list[i].start()
    i += 1
    process_list.append(mp.Process(target = task, args = (i,input_data_list[i*ix:],)))
    process_list[i].start()
